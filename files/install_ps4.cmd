...
IF %ERRORLEVEL% == 0 (
       ...
       IF "%PROCESSOR_ARCHITECTURE%" == "x86" (
             echo x86install
                XCOPY "\\sbt-dfs.ca.sbrf.ru\Distrib\OSA\Microsoft\Net Framework\NDP452-KB2901907-x86-x64-AllOS-ENU.exe" "C:\Temp\" /Y /Q
             XCOPY "\\sbt-dfs.ca.sbrf.ru\Distrib\OSA\Microsoft\PowerShell\Windows Management Framework [4.0]\Windows6.1-KB2819745-x64-MultiPkg.msu" "C:\Temp\" /Y /Q
             cd "C:\Temp"
             ...
             echo x64install
             XCOPY "\\sbt-dfs.ca.sbrf.ru\Distrib\OSA\Microsoft\Net Framework\NDP452-KB2901907-x86-x64-AllOS-ENU.exe" "C:\Temp\" /Y /Q
             XCOPY "\\sbt-dfs.ca.sbrf.ru\Distrib\OSA\Microsoft\PowerShell\Windows Management Framework [4.0]\Windows6.1-KB2819745-x86-MultiPkg.msu" "C:\Temp\" /Y /Q
             cd "C:\Temp"
             start /wait NDP452-KB2901907-x86-x64-AllOS-ENU.exe /quiet /norestart
